...
export default function Header() {
    ...
    return(
        <header className={style.header}>
            ...
            <nav className={style.navbar}>
                ...
                <ul className={isMobile? firstLoad? style.navbar__ul_fl : !burger? style.navbar__ul_close : style.navbar__ul : style.navbar__ul_desktop}>
                    ...
                    <li className={`${style.navbar__li} ${style.navbar__dropdown_controller}`}>
                        <Link href ={`/`}>
                            <a style={{color: path == "/" ? "orange" : ""}}>Lychee Slicer</a>
                        </Link> 
                        <span className={style.navbar__dropdown_controller_icon}></span>
                            <ul className={style.navbar__dropdown}>
                                <li>
                                    <Link href={`/`}>
                                        <a style={{color: path == "/" ? "orange" : ""}}>Overview</a>
                                    </Link>
                                </li>
                    ...
                    <li className={style.navbar__li}>
                        <Link href={`/downloads`}>
                            <a style={{color: path == "/downloads" ? "orange" : ""}}>Downloads</a>
                        </Link>
                    </li>
                    <li className={style.navbar__li}>
                        <a href={`#`}>Pricing</a>
            ...
            <div id={"scrollUp"} className={style.invisible} onClick={handleToTopFunction}> ^ </div>
            {/* </div> */}
        </header>
    )
}